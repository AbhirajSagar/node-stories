    ...
    return (
        <div className="w-screen h-screen bg-dark-blue-black p-3 sm:p-12">
            <nav className="w-full  h-12 flex sm:justify-between justify-center mb-5 items-center">
                ...
                <div className="hidden sm:flex justify-center items-center gap-4 px-2 rounded">
                    ...
                    <h2 className="hidden lg:block text-white font-semibold text-right">{name}</h2>
                </div>
            </nav>
            <div className="w-full flex-col h-max min-h-64 flex justify-start items-start">
                <div className="w-full flex-wrap h-10 gap-1.5 sm:gap-3 flex justify-center items-center my-3">
                    ...
                    <Link 
                        href={"/create"}
                        className="rounded-lg h-full bg-shadow-grey flex justify-center gap-2 items-center cursor-pointer w-22 hover:bg-deep-space-blue hover:text-tiger-orange text-white/50 transition-colors shadow-lg border border-white/5">
